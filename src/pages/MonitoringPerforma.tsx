...
import { Loader2, ArrowLeft, Diamond, Activity, TrendingUp, Zap, RefreshCw, CalendarDays } from 'lucide-react';
...
export default function MonitoringPerforma() {
  ...
  if (!hasPremium) {
    return (
      <>
        <Helmet>
          <title>Monitoring Performa Atlet - HiroCross Plan</title>
        </Helmet>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <Card className="relative overflow-hidden border-amber-300">
              ...
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-xl">Fitur Premium Monitoring Performa</CardTitle>
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm" onClick={() => navigate('/monitoring')} className="gap-2">
