...
export function ProgramMonitoringSection() {
  ...
  if (planData.length === 0) {
    return (
      <div className="text-center py-12">
        <p className="text-muted-foreground">Belum ada program. Buat program di tab Setup terlebih dahulu.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-extrabold">Dashboard Analisis & Efektivitas Program</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="bg-primary text-primary-foreground border-none">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-extrabold mt-1">{stats.totalWeeks}</div>
          </CardContent>
        </Card>
        <Card className="bg-accent text-accent-foreground border-none">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-extrabold mt-1">{stats.planCount}</div>
          </CardContent>
        </Card>
        <Card className="bg-green-600 text-white border-none">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-extrabold mt-1">{stats.realCount}</div>
          </CardContent>
        </Card>
        <Card className="bg-destructive text-destructive-foreground border-none">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-extrabold mt-1">{stats.index}%</div>
          </CardContent>
        </Card>
      </div>
